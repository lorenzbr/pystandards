...
## define function: create empty dataframe with pre-defined column types
...
df_output = df_empty(['date_time_created', 'year', 'dcn', 'rev', 'group', 'title', 'author', 'date_time_upload', 'dllink'],
